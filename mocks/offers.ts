...
export const offers: Offer[] = [
  {
    id: 'o1',
    title: '50% Off',
    description: 'On your first order from any restaurant. Valid for new customers only. Maximum discount ₺50.',
  ...
  },
  {
    id: 'o2',
    title: 'Free Delivery',
    description: 'No delivery fees on orders over ₺100. Available at participating restaurants near you.',
    image: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=400&h=200&fit=crop',
    discount: 'FREE',
    restaurantName: 'Selected Restaurants'
  },
  {
    id: 'o3',
    title: '₺30 Off',
  ...
  },
  {
    ...
    description: 'Show your student ID and get 20% off. Available at all partner restaurants for students.',
